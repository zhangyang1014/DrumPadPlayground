...
将提示词内容复制到项目中的文件（例如 `prompts/auth-nodejs.md`），然后使用 AI 工具的"包含文件"功能在对话中引用该提示词。

不同 AI 工具的使用方式：

- **GitHub Copilot**: 使用 `#<filename>`，例如 `#prompts/auth-nodejs.md`
...
模板已内置 CloudBase MCP 配置和 AI 提示词规则。查看[项目模板](/ai/cloudbase-ai-toolkit/templates)了解更多。
