...
配置后，你可以在通义灵码的 AI 对话中直接操作 CloudBase 服务。
...
无需切换到云控制台，所有操作都可以在通义灵码中用自然语言完成。
...
<RelatedResources ideName="通义灵码" ideDocUrl="https://help.aliyun.com/zh/lingma/user-guide/guide-for-using-mcp" />
