...
配置后，你可以在 WindSurf 的 AI 对话中直接操作 CloudBase 服务。
...
无需切换到云控制台，所有操作都可以在 WindSurf 中用自然语言完成。
...
<IDESelector defaultIDE="windsurf" showInstallButton={false} />

## 常见问题

**Q: MCP 连接失败？**
A: 检查配置文件格式是否正确，重启 WindSurf，确认网络连接正常。
...
<RelatedResources ideName="WindSurf" ideDocUrl="https://docs.windsurf.com/windsurf/cascade/memories" />
