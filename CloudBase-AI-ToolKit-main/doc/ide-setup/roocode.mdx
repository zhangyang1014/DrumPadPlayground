...
配置后，你可以在 RooCode 的 AI 对话中直接操作 CloudBase 服务。
...
无需切换到云控制台，所有操作都可以在 RooCode 中用自然语言完成。
...
<RelatedResources ideName="RooCode" ideDocUrl="https://docs.roocode.com/features/mcp/using-mcp-in-roo" />
