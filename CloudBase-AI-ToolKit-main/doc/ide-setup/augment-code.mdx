...
配置后，你可以在 Augment Code 的 AI 对话中直接操作 CloudBase 服务。
...
无需切换到云控制台，所有操作都可以在 Augment Code 中用自然语言完成。
...
<IDESelector defaultIDE="augment-code" showInstallButton={false} />

## 常见问题

**Q: MCP 连接失败？**
A: 检查配置文件格式是否正确，重启 Augment Code，确认网络连接正常。
...
<RelatedResources ideName="Augment Code" ideDocUrl="https://docs.augmentcode.com/setup-augment/mcp" />
