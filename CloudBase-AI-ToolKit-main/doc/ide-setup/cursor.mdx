...
无需切换到云控制台，所有操作都可以在 Cursor 中用自然语言完成。
...
**Q: MCP 连接失败？**
A: 检查配置文件格式是否正确，重启 Cursor，确认网络连接正常。
...
<RelatedResources ideName="Cursor" ideDocUrl="https://docs.cursor.com/context/model-context-protocol#configuration-locations" />