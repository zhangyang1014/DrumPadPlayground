...
配置后，你可以在 Claude Code 的对话中直接操作 CloudBase 服务。
...
无需切换到云控制台，所有操作都可以在 Claude Code 中用自然语言完成。
...
<RelatedResources ideName="Claude Code" ideDocUrl="https://docs.anthropic.com/en/docs/claude-code/mcp#project-scope" />
