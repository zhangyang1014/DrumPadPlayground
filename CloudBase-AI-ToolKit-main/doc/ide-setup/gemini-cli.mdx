...
配置后，你可以在 Gemini CLI 的对话中直接操作 CloudBase 服务。
...
<IDESelector defaultIDE="gemini-cli" showInstallButton={false} />

## 常见问题

**Q: MCP 连接失败？**
A: 检查配置文件格式是否正确，重启 Gemini CLI，确认网络连接正常。
...
<RelatedResources ideName="Gemini CLI" ideDocUrl="https://ai.google.dev/gemini-api/docs" />
