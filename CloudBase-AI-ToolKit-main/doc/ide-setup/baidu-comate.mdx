...
配置后，你可以在文心快码的 AI 对话中直接操作 CloudBase 服务。
...
无需切换到云控制台，所有操作都可以在文心快码中用自然语言完成。
...
<IDESelector defaultIDE="baidu-comate" showInstallButton={false} />

## 常见问题

**Q: MCP 连接失败？**
A: 检查配置文件格式是否正确，重启文心快码，确认网络连接正常。
...
<RelatedResources ideName="文心快码" ideDocUrl="https://cloud.baidu.com/doc/COMATE/s/km9l4bzwt" />
